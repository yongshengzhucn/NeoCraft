...
return {
  ...
  recommended = true,
  {
    ...
    keys = {
      ...
      { "<space>g", function() Snacks.picker.grep({ hidden = true }) end, desc = "Grep (Root Dir)" },
      -- { "<leader>:", function() Snacks.picker.command_history() end, desc = "Command History" },
      -- { "<leader>h", function() Snacks.picker.notifications() end, desc = "Notification History" },
      { "<space>f", function () Snacks.picker.files() end, desc = "Find Files (Root Dir)" },
      ...
      { "<leader>fr", function() Snacks.picker.smart() end, desc = "Recent (smart)", },
      ...
      { "<leader>fs", function() Snacks.picker.lazy() end, desc = "Search for Plugin Spec" },
      -- { "<leader>fw",function () Snacks.picker.grep_word() end, desc = "Visual selection or word (Root Dir)", mode = { "n", "x" } },
      ...
      { "<space>u", function() Snacks.picker.undo() end, desc = "Undotree" },
    },
  },
  {
    "folke/snacks.nvim",
  ...
  },
  {
    ...
    -- stylua: ignore
    keys = {
      { "<leader>st", function() Snacks.picker.todo_comments() end, desc = "TODO/FIX/HACK.eg" },
